...
Construcción de la base de datos: creación de tablas y carga de información de clientes, productos, categorías y ventas.

Análisis SQL: elaboración de consultas de análisis y consultas con JOIN para integrar información de distintas tablas.

ETL: limpieza, transformación y preparación de los datos con Power Query.

Modelado: construcción de un modelo relacional para análisis en Power BI.

Análisis temporal: creación y utilización de una tabla calendario.

DAX: creación de medidas para ventas, ventas online, acumulados YTD, comparación con el año anterior y crecimiento anual.

Validación: comprobación de los resultados mediante una matriz de validación.

Dashboard: diseño de visualizaciones orientadas a comunicar los principales resultados comerciales.

Uso de IA: revisión de consultas SQL, generación de insights, documentación y reflexión crítica sobre el uso de inteligencia artificial.
...
Conectarse a la instancia de SQL Server utilizada para el proyecto.

Seleccionar la base de datos correspondiente al proyecto.

Ejecutar primero los scripts de creación y carga de datos cuando corresponda.

Ejecutar las consultas de análisis incluidas en los módulos.
